<?php
/**
 * Enhanced Brokerages Management System
 * 
 * Features:
 * - Table creation and setup workflow
 * - Prepopulation with standard Canadian brokerages
...
class BrokeragesDAO extends EnhancedCommonDAO {
    ...
    /**
     * Check if brokerages table exists and is properly set up
     */
    ...
    /**
     * Create brokerages table using schema migration
     */
    public function createTable() {
        try {
            ...
            $this->logError("Error creating brokerages table: " . $e->getMessage());
            throw $e;
        }
    }
    
    /**
     * Prepopulate with standard Canadian brokerages
     */
    public function prepopulateStandardBrokerages() {
        try {
            ...
            // Prepopulated {$inserted} standard brokerages
            return $inserted;
            
        } catch (Exception $e) {
            $this->logError("Error prepopulating brokerages: " . $e->getMessage());
            throw $e;
        }
    }
    
    /**
     * Get all brokerages with optional search and pagination
     */
    public function getAllBrokerages($search = '', $limit = 100, $offset = 0) {
        try {
            ...
            $this->logError("Error getting brokerages: " . $e->getMessage());
            return [];
        }
    }
    
    /**
     * Get total count of brokerages (for pagination)
     */
    public function getBrokeragesCount($search = '') {
        try {
            ...
            $this->logError("Error counting brokerages: " . $e->getMessage());
            return 0;
        }
    }
    ...
    public function getBrokerageById($id) {
        try {
            ...
            $this->logError("Error getting brokerage by ID: " . $e->getMessage());
            return null;
        }
    }
    ...
    public function createBrokerage($name) {
        try {
            ...
            $this->logError("Error creating brokerage: " . $e->getMessage());
            throw $e;
        }
    }
    ...
    public function updateBrokerage($id, $name) {
        try {
            ...
            $this->logError("Error updating brokerage: " . $e->getMessage());
            throw $e;
        }
    }
    
    /**
     * Delete brokerage (with safety checks)
     */
    public function deleteBrokerage($id) {
        try {
            ...
            $this->logError("Error deleting brokerage: " . $e->getMessage());
            throw $e;
        }
    }
}
...
// Get single brokerage for editing
$editBrokerage = null;
if (isset($_GET['edit'])) {
...
<body>
    <div class="container">
        ...
        <?php if ($tableStatus['status'] !== 'no_connection'): ?>
            ...
            <?php elseif ($tableStatus['status'] === 'empty'): ?>
                <div class="setup-section">
                    ...
                    <p>The brokerages table is empty. Would you like to add standard Canadian brokerages?</p>
                    <form method="post" style="display: inline;">
                            ...
                            <?php foreach ($brokerages as $brokerage): ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form method="post" style="display: inline;" onsubmit="return confirm('Are you sure you want to delete this brokerage?');">
        ...
        <div style="margin-top: 40px; padding-top: 20px; border-top: 1px solid #ddd;">
            <p><strong>Related:</strong> <a href="admin_account_types.php">Account Types Management</a> | <a href="admin_accounts.php">Accounts Management</a></p>
        </div>
    </div>
</body>
</html>
