...
class PortfolioDAOApiTest extends TestCase {
    ...
    public function testRestPortfolioRead() {
        $type = 'micro';
        $url = $this->baseRestUrl . '?action=readPortfolio&type=' . urlencode($type);
    ...
    public function testSoapPortfolioRead() {
        ...
        $result = $client->__soapCall('readPortfolio', ['micro']);
