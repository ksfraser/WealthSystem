...
tspink.c, pink noise generator-generates a time series.  The idea is
to produce a 1/f power spectrum distribution by running a cumulative
sum on relaxation processes which are generated by a white noise
generator. See "Fractals, Chaos, Power Laws," Manfred Schroeder,
W. H. Freeman and Company, New York, New York, 1991, ISBN
0-7167-2136-8, pp 122.
...
$Id: tspink.c,v 0.0 2006/01/18 20:28:55 john Exp $
$Log: tspink.c,v $
...
static char rcsid[] = "$Id: tspink.c,v 0.0 2006/01/18 20:28:55 john Exp $"; /* program version */
...
{
    "\n",
    "Generate a pink noise time series\n",
    "Usage: tspink [-t] [-v] number\n",
